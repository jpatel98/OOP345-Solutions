...
In this application you create a class that manages a collection of objects of any type. Based on this class, you create another class that doesn't allow duplicated objects.
